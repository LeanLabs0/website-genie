...
// Some grade/pct pairings are transcribed from the design as-is; the live
// backend computes letters from pct deterministically.
window.GENIE_DEMO = {
  "version": "1.0",
  "scan_id": "wg_demo01",
  ...
  "cost_usd": 0.41,
  "screenshots": {
    "home":     { "hero_url": null, "full_url": null, "width": 1280, "hero_height": 900, "full_height": 6400 },
    "solution": { "hero_url": null, "full_url": null, "width": 1280, "hero_height": 900, "full_height": 5200 }
  },
  "meta": {
    "pages_analyzed": ["https://www.lean-labs.com/", "https://www.lean-labs.com/growth-marketing-team"],
    "word_count": 1240,
  ...
  "copy": {
    ...
    "meta_tags": ["Homepage + solution page", "1,240 words", "Reading level · Grade 9"],
    "subscores": [
      { "key": "clarity",            "label": "Clarity",             "grade": "B+", "pct": 85 },
      { "key": "message_market_fit", "label": "Message–market fit", "grade": "C",  "pct": 58 },
      { "key": "value_proposition",  "label": "Value proposition",   "grade": "C+", "pct": 63 },
      { "key": "differentiation",    "label": "Differentiation",     "grade": "C-", "pct": 48 },
      { "key": "voice_emotion",      "label": "Voice & emotion",     "grade": "B",  "pct": 78 }
    ],
    "findings": [
      { "n": 1, "title": "You lack an intermediate CTA",
        ...
        "grade": "C", "pct": 55, "pass": false, "pin": null },
      { "n": 2, "title": "You overcome objections well",
        "detail": "Your FAQ and risk-reversal copy pre-empt the top buyer concerns before they’re asked.",
        "fix": null,
        "grade": "A-", "pct": 91, "pass": true, "pin": null },
      { "n": 3, "title": "Your value proposition is “buried”",
        ...
        "grade": "C+", "pct": 63, "pass": false, "pin": null },
      { "n": 4, "title": "Your differentiation is thin",
        ...
        "grade": "C-", "pct": 48, "pass": false, "pin": null }
    ],
  ...
  "credibility": {
    ...
    "meta_tags": ["On-site only", "Solution page", "EEAT"],
    "subscores": [
      { "key": "experience",        "label": "Experience",        "grade": "B",  "pct": 78 },
      { "key": "expertise",         "label": "Expertise",         "grade": "B+", "pct": 85 },
      { "key": "authoritativeness", "label": "Authoritativeness", "grade": "C",  "pct": 58 },
      { "key": "trust",             "label": "Trust",             "grade": "C-", "pct": 48 }
    ],
    "proof_coverage": { "covered": 1, "total": 6, "label": "1 / 6", "pct": 17 },
    "findings": [
      { "n": 1, "title": "3 of 6 core claims have no proof",
        ...
        "grade": "D", "pct": 32, "pass": false, "pin": null },
      { "n": 2, "title": "Your credential badges are strong",
        "detail": "Diamond Partner status and the client logo wall establish a solid baseline of authority.",
        "fix": null,
        "grade": "B+", "pct": 88, "pass": true, "pin": null },
      { "n": 3, "title": "Your revenue stat has no source",
        "detail": "“$100M+ generated” appears with no source, date, or link, easy to doubt.",
        "fix": "Cite the source and timeframe.",
        "grade": "C", "pct": 55, "pass": false, "pin": null },
      { "n": 4, "title": "No testimonials on your solution page",
        ...
        "grade": "D", "pct": 30, "pass": false, "pin": null }
    ],
    "claims": [
      { "claim": "“$100M+ in revenue generated”", "current_proof": "Stat, no source",  "recommendation": "Add source + date + link" },
      { "claim": "“A predictable pipeline”",       "current_proof": "None",            "recommendation": "Add a named client result" },
      { "claim": "“Used by high-growth teams”",    "current_proof": "Unnamed logos",   "recommendation": "Name the logos / add a quote" }
    ],
  ...
  "conversion": {
    ...
    "meta_tags": ["Landing / solution page"],
    "subscores": [
      { "key": "offer_diversity", "label": "Offer diversity",        "grade": "D",  "pct": 28 },
      { "key": "solution_steps",  "label": "On-page solution steps", "grade": "D",  "pct": 34 },
      { "key": "path_clarity",    "label": "Path clarity",           "grade": "C",  "pct": 55 },
      { "key": "cta_strength",    "label": "CTA strength",           "grade": "C+", "pct": 65 }
    ],
    "offer_ladder": [
      { "key": "demo_call",   "label": "Demo call",   "present": true,  "evidence": "Primary hero CTA; demo buttons repeat down the page." },
      { "key": "mini_class",  "label": "Mini-class",  "present": false, "evidence": null },
      { "key": "workshop",    "label": "Workshop",    "present": false, "evidence": null },
      { "key": "template",    "label": "Template",    "present": false, "evidence": null },
      { "key": "checklist",   "label": "Checklist",   "present": false, "evidence": null },
      { "key": "toolkit",     "label": "Toolkit",     "present": false, "evidence": null },
      { "key": "calculator",  "label": "Calculator",  "present": false, "evidence": null },
      { "key": "webinar",     "label": "Webinar",     "present": false, "evidence": null },
      { "key": "accelerator", "label": "Accelerator", "present": false, "evidence": null }
    ],
    "findings": [
      { "n": 1, "title": "You’re showing only one offer",
  ...
  "rollup": {
    ...
    "pct": 62,
    "pages": [
      { "key": "copy",        "label": "Copy",        "grade": "B-", "pct": 70 },
      { "key": "credibility", "label": "Credibility", "grade": "C",  "pct": 58 },
      { "key": "conversion",  "label": "Conversion",  "grade": "C-", "pct": 48 }
    ],
